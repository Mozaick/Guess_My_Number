'use strict';
// when you input a num and hit 'check' btn a random num generates, and that random num shows up in '?'
...
// When CLICKED change '?' to an icon and clear the input field and re-autofocus it
